...
public class ListOfRegisteredParticipants_fitnessClass extends JFrame {
	 ...
	 * Create the frame.
	 */
	public ListOfRegisteredParticipants_fitnessClass(int row) {
		this.row=row;
		setTitle("Partcipants Details");
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setBounds(300, 100, 874, 488);
		...
		lb.setBounds(294, 11, 270, 59);
		contentPane.add(lb);
		
		        //adding scrollPane for table
				scrollPane = new JScrollPane();
				scrollPane.setBounds(10, 101, 838, 272);
				...
				Close_btn.setBounds(367, 403, 123, 35);
...
void DisplayTableData() {
	 ...
	 ParticipantsDetails_Table.setModel(model);
  	 ...
  	 ParticipantsDetails_Table.getColumnModel().getColumn(7).setCellRenderer(new ButtonRenderer1());
  	 ParticipantsDetails_Table.getColumnModel().getColumn(7).setCellEditor(new ButtonEditor1(new JTextField(),memberShipIds,row,this));
...
int classIndex;
ListOfRegisteredParticipants_fitnessClass parentWindow;
public ButtonEditor1(JTextField txt, ArrayList<String> memberShipIds, int classIndex, ListOfRegisteredParticipants_fitnessClass parentWindow) {
super(txt);
...
private void deleteParticipantFromClass() {
	 ...
	 int tagetIndex=0;
		...
		StartingWindow.fitnessClassDataHolder.get(classIndex).getParticipantDetails().remove(tagetIndex);
		new ListOfRegisteredParticipants_fitnessClass(classIndex);
